...
const testimonials = [
  ...
  },
  {
    name: "Alp",
    message:
      "I started working on my singing like 3-4 months ago. I had couple different vocal coaches but they were all talking about different things and I felt that somehow my end goal became ” hit ” this note, that note instead of doing what I love and what I want to do, which is performing. And short after realizing this, I stopped my lessons and started looking for new vocal coach, looked here and there and I saw this discord at Reddit, I was like couldn’t hurt let’s give it a shot. I joined couple group lessons, asked many questions then I started taking lessons from Mia. But just waow, it’s been just three lessons but oh boy even in this time my range extended like perfect fourth up (F5-A#5) and couple notes down and I feel a loooot more comfortable and in general singing and performing looks more achievable now. My most favourite part of her lessons is she somehow manages to listen and answer every single question you ask (even if you are like me and ask the world’s handpicked most stupid questions). It’s just awesome.",
  },
  {
    name: "Milla",
    message:
