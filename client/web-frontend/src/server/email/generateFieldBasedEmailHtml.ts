    ...
    switch (key) {
      case "message":
        return (str += `<h3 class="form-heading" align="left">${
          fields[key]
        }</h3><p class="form-answer" align="left">${withHTMLLineBreaks(
          val,
        )}</p>`);

      default:
        return (str += `<h3 class="form-heading" align="left">${fields[key]}</h3><p class="form-answer" align="left">${val}</p>`);
    }
  }, "");
                    ...
                    <td>
                      ...
                      >
                        <tr>
                          ...
                          >
                            <h2 style="line-height: 1.5">${heading}</h2>
