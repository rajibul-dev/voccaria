...
export default function SearchModal() {
  ...
  const modalRef = useOutsideClick(() => toggleSearch(false));
    ...
    >
      ...
      >
        <div className="relative">
          ...
          />
          <span
            className="absolute top-[50%] right-3 w-fit -translate-y-[90%] cursor-pointer rounded-sm border-1 border-slate-400 bg-slate-200 px-2.5 py-1 text-xs font-bold text-slate-400 transition-colors group-hover:text-slate-500 hover:bg-slate-300 dark:bg-slate-700 group-hover:dark:text-slate-400 dark:hover:bg-slate-800"
