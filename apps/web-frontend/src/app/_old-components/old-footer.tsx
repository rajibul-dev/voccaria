...
export default function OldFooter() {
  ...
  return (
    <footer className="bg-gray-300 pt-[5.6rem] pb-[5.6rem] max-lg:py-[8rem] dark:bg-gray-700">
      <div
        className={clsx(
      ...
      >
        <div
          className={clsx(
            "mb-[.6rem] flex flex-col gap-[2rem] justify-self-end border-b border-b-gray-800 pb-[.8rem] max-[1100px]:order-2 max-[1100px]:max-w-[72ch] max-[1100px]:justify-self-center dark:border-b-gray-300",
          )}
        >
          <OldTwoLogosAndSlash />
          <p
            className={clsx(
              "text-end text-[1.6rem] leading-[1.5] text-gray-800 max-[1100px]:text-center max-md:text-[2rem] max-md:leading-[1.7] dark:text-gray-300",
            )}
          >
          ...
          {footerLinks.map((section) => (
            ...
            >
              <h2
                ...
                className="mb-[1.1rem] text-[1.6rem] leading-[1.5] font-semibold text-gray-800 max-md:text-[2rem] max-md:leading-[1.7] dark:text-white"
              >
                {section.section}
              </h2>
        ...
        <div
          className={clsx(
            "mb-[.6rem] max-w-[44ch] justify-self-start border-b border-b-gray-800 pb-[.8rem] max-[1100px]:order-3 max-[1100px]:justify-self-center max-lg:max-w-[57ch] max-sm:w-full dark:border-b-gray-300",
          )}
        >
          <p
            className={clsx(
              "text-end text-[1.8rem] text-gray-800 max-[1100px]:text-start max-md:text-[2.2rem] max-md:leading-[1.6] dark:text-gray-300",
            )}
          >
